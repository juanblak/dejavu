...
# test_folder = args[0]
# test_folder = "191108/reaction" #############test file folder to cut
test_folder = "191108/fancam" #############test file folder to cut
...
#######################
for i in range(options.secs, options.secs + 1, 1):
